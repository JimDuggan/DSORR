...
author: "Visualisation using ggplot2"
output:
...
```{r, echo=F,out.width='100%',fig.cap='Sample geoms'}
...
```{r, echo=F,out.width='100%',fig.cap='Diamonds attributes'}
 knitr::include_graphics("images/03 Diamonds.png")
```


## Diamonds summary
```{r, echo=F,out.width='100%',fig.cap='Data set summary'}
...
```{r, echo=F,out.width='50%',fig.cap='Layered Grammar of Graphics'}

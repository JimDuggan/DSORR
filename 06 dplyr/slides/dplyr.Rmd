...
author: "Analysis of Data  with dplyr"
output:
...
```{r, echo=F,out.width='100%',fig.cap='Key dplyr functions'}
...
## Overall idea
```{r, echo=F,out.width='100%',fig.cap='Overall summary process'}
 knitr::include_graphics("images/11 Overall.png")
```

## Useful Summary Functions
```{r, echo=F,out.width='100%',fig.cap='Summary Functions'}
...
```{r, echo=F,out.width='75%',fig.cap='Summary of flights data'}
